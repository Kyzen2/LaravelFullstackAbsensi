            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div class="glass-card p-10 rounded-[48px] border-white/5 group hover:bg-rose-500/10 transition-all duration-500 relative overflow-hidden">
                    ...
                    <div class="relative z-10 space-y-6">
                        ...
                        <div>
                            <h3 class="text-2xl font-black text-white tracking-tight mb-2">Helpdesk & SLA</h3>
                            <p class="text-slate-500 text-xs font-semibold uppercase tracking-widest leading-relaxed">Kelola tiket aduan dan komunikasi teknis pengguna.</p>
                        </div>
                        <a href="{{ route('admin.helpdesk.index') }}" class="flex items-center gap-2 text-[10px] font-black text-rose-400 uppercase tracking-[0.2em] group-hover:gap-4 transition-all">
                            Buka Antrean <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="3" d="M17 8l4 4m0 0l-4 4m4-4H3"></path></svg>
                        </a>
                    </div>
                </div>
            </div>
