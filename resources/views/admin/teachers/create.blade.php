<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center gap-3">
            ...
            <h2 class="text-sm font-black text-slate-400 uppercase tracking-[0.2em]">
                Guru & Staf / <span class="text-white">Tambah Baru</span>
            </h2>
        </div>
    </x-slot>
    ...
    <div class="py-10 pb-32">
        <div class="max-w-3xl mx-auto px-6">
            <div class="mb-12">
                <h1 class="text-4xl font-black text-white tracking-tighter mb-2">Tambah Guru</h1>
                <p class="text-slate-500 font-medium text-sm">Daftarkan tenaga pendidik baru ke dalam sistem.</p>
            </div>
                ...
                <div class="glass-card rounded-[40px] border-white/5 p-8 md:p-12">
                    <div class="grid grid-cols-1 gap-8">
                        ...
                        <div class="space-y-2">
                            ...
                            <input type="text" name="nama_guru" value="{{ old('nama_guru') }}" placeholder="Contoh: Budi Sudarsono, M.Kom" required
                        ...
                        <div class="space-y-2">
                            ...
                            <input type="text" name="nip" value="{{ old('nip') }}" placeholder="Masukkan NIP" required
                                class="w-full bg-white/5 border border-white/10 rounded-2xl py-4 px-6 text-sm font-bold text-white placeholder-slate-600 focus:outline-none focus:ring-4 focus:ring-indigo-500/10 focus:border-indigo-500/50 transition-all">
                            <p class="text-[10px] text-slate-600 font-medium ml-4 mt-1 italic">*NIP akan digunakan sebagai Serial Number untuk login.</p>
                        ...
                        <div class="space-y-2">
                            ...
                            <input type="email" name="email" value="{{ old('email') }}" placeholder="guru@sekolah.sch.id"
                                class="w-full bg-white/5 border border-white/10 rounded-2xl py-4 px-6 text-sm font-bold text-white placeholder-slate-600 focus:outline-none focus:ring-4 focus:ring-indigo-500/10 focus:border-indigo-500/50 transition-all">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-8 pt-4 border-t border-white/5">
                            <!-- Password -->
                            <div class="space-y-2">
                                <label class="text-[10px] font-black text-slate-500 uppercase tracking-[0.2em] ml-4">Password</label>
