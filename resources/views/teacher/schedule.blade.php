        ...
        <div class="max-w-md mx-auto px-6 relative z-10">
            ...
            <div class="space-y-4">
                ...
                <div class="glass-card p-5 rounded-[2rem] border-white/5 relative overflow-hidden group hover:border-indigo-500/30 transition-all duration-500">
                    ...
                    <!-- Action Trigger (Generate QR Shortcut) -->
                    <a href="{{ route('teacher.qr', $item) }}" class="mt-4 w-full py-3 rounded-xl bg-white/5 border border-white/5 flex items-center justify-center gap-2 text-slate-400 group-hover:bg-indigo-500 group-hover:text-white group-hover:border-indigo-400 transition-all duration-300">
                        ...
                        <span class="text-[10px] font-black uppercase tracking-[0.2em]">Open Session</span>
                    </a>
