...
$kelas = Kelas::firstOrCreate(['nama_kelas' => $targetClass], ['tahun_ajaran_id' => $ta->id]);
...
echo "TOTAL IMPORTED: " . $importCount . "\n";
echo "VERIFYING DATABASE COUNT: " . User::where('role', 'siswa')->count() . "\n";

$turky = User::where('serial_number', '0081506973')->first();
if ($turky) {
    echo "TURKY VERIFIED IN DB!\n";
} else {
    echo "TURKY STILL MISSING!\n";
}
